...
public class Iloinen implements Screen, InputProcessor {
    zenSpace game;
    ...
    public Iloinen(zenSpace game) {
        ...
        clickableTexts.add(new ClickableText("CLEARSCREEN", 750, 460, font));
    ...
    public void render(float delta) {
        ...
        font.draw(batch, "ILOINEN", 325,400);
        font.draw(batch, "Piirrä hymynaama höpsö :)", 200, 350);
        if(!isEmpty) {
    ...
    public boolean touchDragged(int screenX, int screenY, int pointer) {
        ...
        newX = vec.x;
        newY = vec.y;
        Gdx.app.log("TAAA", "NEW " + newX + " X JA Y "  + newY);
